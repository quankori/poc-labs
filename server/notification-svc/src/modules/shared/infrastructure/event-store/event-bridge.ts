...
import { EVENT_STORE_CONNECTION } from 'src/modules/core/core.constants';
  ...
  implements OnApplicationBootstrap, OnApplicationShutdown
{
  ...
  onApplicationBootstrap() {
    // In the poll-based approach, instead of using a change stream (as we're doing here),
    // we would periodically poll the event store for new events. To keep track of what events we already processed,
